import { PartType, ProductCategory, ProductStatus } from '@/enum/category-type';
...
export interface User extends BaseEntity {
  ...
  province?: string | null; // Thành phố (có thể null)
  ward?: string | null; // Bang hoặc tỉnh (có thể null)
  district?: string | null; // Quốc gia (có thể null)
...
export interface Brand extends BaseEntity {
  ...
  logoURL?: string | null; // Đường dẫn hình ảnh logo (có thể null)
}
